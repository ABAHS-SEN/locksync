...
const Navbar = () => {
  return (
    <AppBar position="static" style={{ marginBottom: '20px', backgroundColor: 'green' }}>
      <Toolbar>
        <Typography variant="h6" style={{ flexGrow: 1, color: 'black', font:'bold',display :'flex' , gap : '1vw',justifyItems : 'center' }}>
         
        <Button color="inherit" component={Link} to="/">LockSync</Button>
