...
const Usage = () => {
  ...
  return (
    <div className="flex justify-between bg-green-600 text-black min-h-full px-40" ref={containerRef}>
      <div className="max-w-[30vw] my-5 flex flex-col gap-28">
        <h1 className="text-5xl mb-4 font-poppins font-bold mt-14 text-black">
